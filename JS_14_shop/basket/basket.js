...
const checkedProducts = Object.values(JSON.parse(localStorage.getItem('productBasket')))
...
function renderBasket() {
 ...
 deleteBtn.forEach(btn => {
   btn.addEventListener('click',(e)=>{
      const updateChekedProducts = checkedProducts.filter(product => product.article !== e.target.dataset.article)
