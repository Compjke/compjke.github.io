...
export function renderPopup (e) {
  if(!e.target.classList.contains('collections__link')){
   ...
   const currentProductArticle = productCart.querySelector('.collections__link').dataset.article
   const currentProduct = PRODUCTS.slice().find(prod => prod.article === currentProductArticle)
